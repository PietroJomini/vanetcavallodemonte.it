...
<Splide options={{
    ...
    <SplideSlide><div class="w-screen h-screen bg-blue-400"></div></SplideSlide>
    <SplideSlide><div class="w-screen h-screen bg-yellow-400"></div></SplideSlide>
    <SplideSlide><div class="w-screen h-screen bg-green-400"></div></SplideSlide>
</Splide>
...
<div class="p-10 pt-0 w-full">
    ...
    <div class="flex xl:flex-row flex-col p-4 w-full xl:max-w-7xl mx-auto group py-10">
        <div class="xl:w-1/2 h-96 bg-green-200 xl:order-first"></div>
        <div class="group xl:w-1/2 xl:h-96 py-10 flex items-center justify-center text-center flex-col">
            <div class="transition-all pb-3 text-3xl w-full font-cabin text-gray-800">{$t('home.cards.1.title')}</div>
            <div class="p-2 xl:w-2/3 text-gray-700">{$t('home.cards.1.content')}</div>
            <span class="text-sm underline font-bold italic mt-2 cursor-pointer"><a
    ...
    <div class="flex xl:flex-row flex-col p-4 w-full xl:max-w-7xl mx-auto group py-10">
        <div class="xl:w-1/2 h-96 bg-green-200 xl:order-last"></div>
        <div class="group xl:w-1/2 xl:h-96 py-10 flex items-center justify-center text-center flex-col">
            <div class="transition-all pb-3 text-3xl w-full font-cabin text-gray-800">{$t('home.cards.2.title')}</div>
