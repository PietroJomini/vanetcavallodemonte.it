...
export default {
	...
	ca: { name: 'Catalan; Valencian', native: 'Català' },
	...
	cs: { name: 'Czech', native: 'česky, čeština' },
	...
	ff: { name: 'Fula; Fulah; Pulaar; Pular', native: 'Fulfulde, Pulaar, Pular' },
	gl: { name: 'Galician', native: 'Galego' },
	ka: { name: 'Georgian', native: 'ქართული' },
	de: { name: 'German', native: 'Deutsch' },
	el: { name: 'Greek, Modern', native: 'Ελληνικά' },
	...
	li: { name: 'Limburgish, Limburgan, Limburger', native: 'Limburgs' },
	...
	nv: { name: 'Navajo, Navaho', native: 'Diné bizaad, Dinékʼehǰí' },
	...
	pa: { name: 'Panjabi, Punjabi', native: 'ਪੰਜਾਬੀ, پنجابی‎' },
	...
	gd: { name: 'Scottish Gaelic; Gaelic', native: 'Gàidhlig' },
	...
	es: { name: 'Spanish; Castilian', native: 'español, castellano' },
	...
	bo: { name: 'Tibetan Standard, Tibetan, Central', native: 'བོད་ཡིག' },
	...
	ug: { name: 'Uighur, Uyghur', native: 'Uyƣurqə, ئۇيغۇرچە‎' },
	uk: { name: 'Ukrainian', native: 'українська' },
	ur: { name: 'Urdu', native: 'اردو' },
	uz: { name: 'Uzbek', native: 'zbek, Ўзбек, أۇزبېك‎' },
